...
public class Destinations extends JFrame implements Runnable {
  ...
  // int i;
   ...
   public void run()
   {
       String[] text = new String[]{"JW Marriot Hotel","Nandarin Oriental Hotel","Four Seasons Hotel","Radisson Hotel","Classio Hotel","The Bay Club Hotel","Breeze Blows Hotel","Quick Stop Hotel","Happy Mornings Hotel","Moss View Hotel"};                                                                                                   
       try{
           for(int i =0; i<=9; i++)
       {
...
//       caption = new JLabel();
//       caption.setBounds(50,250,900,100);
